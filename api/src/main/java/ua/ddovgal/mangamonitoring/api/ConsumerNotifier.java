...
import ua.ddovgal.mangamonitoring.domain.GenericNotification;
import ua.ddovgal.mangamonitoring.domain.Manga;

/**
 * Service that provides ability to send notifications to certain consumer. Contains methods for sending each notification type.
 *
...
public interface ConsumerNotifier<T extends AuthenticationData> {
     ...
     *
     * @param authData     authentication data that describes account to receive notification in the scope of a current notifier.
    ...
    /**
     * Notifies user by provided {@code authData} that some number of new (really new, not just updated) {@code manga} chapters released.
     *
     * @param authData      authentication data that describes account to receive notification in the scope of a current notifier.
    ...
    /**
     * Notifies user by provided {@code authData} that new chapter released, but by some indicators it seems that it's just some kind of
     * update.
     *
     * @param authData       authentication data that describes account to receive notification in the scope of a current notifier.
    ...
    /**
     * Notifies user by provided {@code authData} that some number of chapters was deleted.
     *
     * @param authData authentication data that describes account to receive notification in the scope of a current notifier.
     * @param manga    notification associated manga.
     */
    ...
    /**
     * Notifies user by provided {@code authData} that provided {@code manga}s {@link MangaProvider} didn't have chapters, and now they have
     * appeared.
     *
     * @param authData      authentication data that describes account to receive notification in the scope of a current notifier.
    ...
    /**
     * Notifies user by provided {@code authData} that provided {@code manga} last chapter has not been changed, but number of chapters has
